...
const data = {
	...
	'CbteTipo' 		: 1, // Tipo de comprobante (ver tipos disponibles) A=1 B=6 C=11
	'Concepto' 		: 1, // Concepto del Comprobante: (1)Productos, (2)Servicios, (3)Productos y Servicios
	'DocTipo' 		: 80, // Tipo de documento del comprador (ver tipos disponibles)
	'DocNro' 		: 27186163228, // Numero de documento del comprador
...
afip.ElectronicBilling.createVoucher(data, true).then(res => {
	console.log(res)
});
